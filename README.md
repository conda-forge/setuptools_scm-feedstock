...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5312&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/setuptools_scm-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `setuptools-scm, setuptools_scm` can be installed with `conda`:
...
```
mamba install setuptools-scm setuptools_scm
```

It is possible to list all of the versions of `setuptools-scm` available on your platform with `conda`:
...
```
mamba search setuptools-scm --channel conda-forge
```
...
mamba repoquery search setuptools-scm --channel conda-forge

# List packages depending on `setuptools-scm`:
mamba repoquery whoneeds setuptools-scm --channel conda-forge

# List dependencies of `setuptools-scm`:
mamba repoquery depends setuptools-scm --channel conda-forge
```
